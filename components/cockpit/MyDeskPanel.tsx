              ...
              return (
                <div key={c.sessionId} className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-[var(--color-surface-2)] group">
                  ...
                  <button
                    ...
                    className="shrink-0 inline-flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 opacity-0 group-hover:opacity-100 hover:bg-emerald-100 transition-all disabled:opacity-50"
                  >

    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 mt-1 w-64 bg-white rounded-xl border border-slate-200 shadow-xl z-50 overflow-hidden">
...
function ViewRow({ v, active, onApply, onDelete }: {
  ...
  return (
    <div className={`flex items-center gap-2 px-3 py-2 hover:bg-slate-50 cursor-pointer ${active ? "bg-blue-50" : ""}`} onClick={onApply}>
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
        <div className="px-5 py-3 border-b border-slate-200 flex items-center justify-between">
          <div className="text-sm font-black text-slate-900 flex items-center gap-2">
            <Save className="w-4 h-4 text-emerald-600" /> Save current view
          </div>

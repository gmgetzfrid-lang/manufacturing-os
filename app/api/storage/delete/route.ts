...
export async function DELETE(req: NextRequest) {
  ...
  // any authenticated user could delete any tenant's files by naming the key
  // (destructive cross-tenant IDOR). Mirrors the check in download-url.
  // Non-org-prefixed keys keep their prior behavior.

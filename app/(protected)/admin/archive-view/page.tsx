...
export default function ArchiveViewPage() {
  ...
  // (admin.archive_view — role tokens, then a per-person grant, fail closed
  // on a policy-load error). The client-side policy read that used to live
  // here failed OPEN on error.
  return (

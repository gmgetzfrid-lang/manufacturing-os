-- ════════════════════════════════════════════════════════════════════
-- CATCHUP_2026-05-28.sql  (v3 — adds Phase 7 milestones)
-- ════════════════════════════════════════════════════════════════════
--
...
--
-- Bundles the nine migration files added in this push:
--
...
--   20260614_phase7_milestones.sql              milestones table + RLS
--
-- All statements are idempotent (IF NOT EXISTS / CREATE OR REPLACE /
-- DROP IF EXISTS). Safe to re-run.
--
-- This file is a regenerable bundle — source of truth is the
-- individual migration files under supabase/migrations/.
-- ════════════════════════════════════════════════════════════════════

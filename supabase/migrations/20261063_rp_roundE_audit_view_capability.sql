...
--
--   1. org_capability_allows_for: the body from 20261057 (20261052 + the
--      DEC-13 stage 3 row) VERBATIM plus ONE line in the shipped-default CASE —
...
--      20261057 and the CASE against lib/capabilityPolicy.ts CAPABILITY_DEFS.

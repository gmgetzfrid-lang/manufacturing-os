        ...
        {selectedVersion?.fileUrl && (
            <div className="space-y-2">
                <div
                  ...
                  className="relative group rounded-xl border border-slate-200 overflow-hidden h-48 bg-slate-100 cursor-pointer"
                ...
                <button
                  onClick={onFullScreen}
                  className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-slate-900 text-white text-xs font-bold hover:bg-slate-800 transition-all shadow-sm"
                >
                    <Maximize2 className="w-3.5 h-3.5" /> Open Full View
                </button>
            </div>

...
- Migrations: `20261040` — **printed for operator paste; pending apply** (flips to "applied & verified live" when the 6 probe booleans come back); `20261041` (node_visible) — printed only AFTER `20261040` verifies, per DEC-2.

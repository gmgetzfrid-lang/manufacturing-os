...
- Migrations: `20261040` — **applied & verified live 2026-09-01** (6-point probe all true); `20261041` (node_visible) — **printed for operator paste; pending apply** (4-point probe rides the file).

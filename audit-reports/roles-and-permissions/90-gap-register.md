...
- Migration: `20261044` — pending apply. Pre-flight correction 2026-09-02: the folder-level admin-grant bound is a BEFORE UPDATE trigger (`collections_guard_access`), not a policy disjunct — see `DEL-1` for why the disjunct was unenforceable.

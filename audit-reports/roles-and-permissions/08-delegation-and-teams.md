...
- Migration: `20261045` — **applied & verified live 2026-09-02** (9-point probe all true; inventory: 4 org-level audit rows now admin-class only, 0 pending drafts where DEC-21 binds today).

...
- **Status:** OPEN
- **Verification:** CONFIRMED
- **Locations:** `supabase/schema.sql:433-434`, `app/(protected)/settings/notifications/page.tsx:143`, `lib/notifications.ts:163`, `lib/notify/dispatch.ts:56`, `lib/notifications.ts:276-282`, `app/(protected)/requests/page.tsx:508`, `vercel.json:3-12`
